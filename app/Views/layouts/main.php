...
<head>
    ...
    <title>MkVids – Movies & TV Shows</title>
            ...
            <div class="col-12">
                <div class="header__content">
                    ...
                    <ul class="header__nav">
                        ...
                        <li class="header__nav-item">
                            <a class="header__nav-link" href="<?= base_url('trending') ?>">Trending</a>
                        </li>
                        <li class="header__nav-item">
                            <a class="header__nav-link" href="<?= base_url('movies') ?>">Movies</a>
                        </li>
                        <li class="header__nav-item">
                            <a class="header__nav-link" href="<?= base_url('tv-shows') ?>">TV Shows</a>
                        </li>
                    </ul>

                    <div class="header__actions">
                        <form action="#" class="header__form">
                            <input class="header__form-input" type="text" placeholder="Quick Search...">
    ...
    <div class="container">
        <div class="row d-none">
            ...
            <div class="col-6 col-md-4 col-lg-3 col-xl-2 order-1 order-md-2 order-lg-1 order-xl-2 offset-md-2 offset-lg-0 offset-xl-1">
                <h6 class="footer__title">MkVids</h6>
        ...
        <div class="row">
            <div class="col-12">
                <div class="footer__content">
                    ...
                    <small class="footer__copyright">© MkVids 2023.</small>
                </div>
            </div>
        </div>
    </div>
