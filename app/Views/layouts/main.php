...
<head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="<?=base_url('public/main/')?>css/bootstrap-reboot.min.css">
    <link rel="stylesheet" href="<?=base_url('public/main/')?>css/bootstrap-grid.min.css">
    <link rel="stylesheet" href="<?=base_url('public/main/')?>css/owl.carousel.min.css">
    <link rel="stylesheet" href="<?=base_url('public/main/')?>css/slider-radio.css">
    <link rel="stylesheet" href="<?=base_url('public/main/')?>css/select2.min.css">
    <link rel="stylesheet" href="<?=base_url('public/main/')?>css/magnific-popup.css">
    <link rel="stylesheet" href="<?=base_url('public/main/')?>css/plyr.css">
    <link rel="stylesheet" href="<?=base_url('public/main/')?>css/main.css">

    <!-- Favicons -->
    <link rel="icon" type="image/png" href="<?=base_url('public/main/')?>icon/favicon-32x32.png" sizes="32x32">
    <link rel="apple-touch-icon" href="<?=base_url('public/main/')?>icon/favicon-32x32.png">
            ...
            <div class="col-12">
                <div class="header__content">
                    ...
                    <a href="index.html" class="header__logo">
                        <img src="<?=base_url('public/main/')?>img/logo.svg" alt="Movies & TV Shows, Online cinema HTML Template">
                    </a>
        ...
        <div class="row d-none">
            <div class="col-12 col-sm-8 col-md-6 col-lg-4 col-xl-3 order-4 order-md-1 order-lg-4 order-xl-1">
                <div class="footer__flixtv">
                    <img src="<?=base_url('public/main/')?>img/logo.svg" alt="">
                </div>
...
<!-- JS -->
<script src="<?=base_url('public/main/')?>js/jquery-3.5.1.min.js"></script>
<script src="<?=base_url('public/main/')?>js/bootstrap.bundle.min.js"></script>
<script src="<?=base_url('public/main/')?>js/owl.carousel.min.js"></script>
<script src="<?=base_url('public/main/')?>js/slider-radio.js"></script>
<script src="<?=base_url('public/main/')?>js/select2.min.js"></script>
<script src="<?=base_url('public/main/')?>js/smooth-scrollbar.js"></script>
<script src="<?=base_url('public/main/')?>js/jquery.magnific-popup.min.js"></script>
<script src="<?=base_url('public/main/')?>js/plyr.min.js"></script>
<script src="<?=base_url('public/main/')?>js/main.js"></script>
</body>
</html>