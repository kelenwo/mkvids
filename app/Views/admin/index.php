			...
			<div class="row">
				...
				<div class="col-12">
					<div class="main__title">
						...
						<a href="<?= base_url('public/admin/')?>add-item.html" class="main__title-link">add item</a>
					</div>
				</div>
				<!-- end main title -->
					...
					<div class="dashbox">
						<div class="dashbox__title">
							...
							<div class="dashbox__wrap">
								<a class="dashbox__refresh" href="<?= base_url('public/admin/')?>#"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21,11a1,1,0,0,0-1,1,8.05,8.05,0,1,1-2.22-5.5h-2.4a1,1,0,0,0,0,2h4.53a1,1,0,0,0,1-1V3a1,1,0,0,0-2,0V4.77A10,10,0,1,0,22,12,1,1,0,0,0,21,11Z"/></svg></a>
								<a class="dashbox__more" href="<?= base_url('public/admin/')?>catalog.html">View All</a>
							</div>
						</div>
							...
							<table class="main__table main__table--dash">
								...
								<tbody>
									<tr>
										...
										<td>
											<div class="main__table-text"><a href="<?= base_url('public/admin/')?>#">I Dream in Another Language</a></div>
										</td>
										<td>
									...
									<tr>
										...
										<td>
											<div class="main__table-text"><a href="<?= base_url('public/admin/')?>#">Benched</a></div>
										</td>
										<td>
											<div class="main__table-text">Movie</div>
										</td>
									...
									<tr>
										...
										<td>
											<div class="main__table-text"><a href="<?= base_url('public/admin/')?>#">Whitney</a></div>
										</td>
										<td>
									...
									<tr>
										...
										<td>
											<div class="main__table-text"><a href="<?= base_url('public/admin/')?>#">Blindspotting 2</a></div>
										</td>
										<td>
											<div class="main__table-text">TV Show</div>
										</td>
									...
									<tr>
										...
										<td>
											<div class="main__table-text"><a href="<?= base_url('public/admin/')?>#">Blindspotting</a></div>
										</td>
										<td>
											<div class="main__table-text">TV Show</div>
										</td>
				...
				<div class="col-12 col-xl-6">
					<div class="dashbox">
						<div class="dashbox__title">
							...
							<div class="dashbox__wrap">
								<a class="dashbox__refresh" href="<?= base_url('public/admin/')?>#"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21,11a1,1,0,0,0-1,1,8.05,8.05,0,1,1-2.22-5.5h-2.4a1,1,0,0,0,0,2h4.53a1,1,0,0,0,1-1V3a1,1,0,0,0-2,0V4.77A10,10,0,1,0,22,12,1,1,0,0,0,21,11Z"/></svg></a>
								<a class="dashbox__more" href="<?= base_url('public/admin/')?>users.html">View All</a>
							</div>
						</div>
							...
							<table class="main__table main__table--dash">
								...
								<tbody>
									<tr>
										...
										<td>
											<div class="main__table-text"><a href="<?= base_url('public/admin/')?>#">Brian Cranston</a></div>
										</td>
										<td>
									...
									<tr>
										...
										<td>
											<div class="main__table-text"><a href="<?= base_url('public/admin/')?>#">Jesse Plemons</a></div>
										</td>
										<td>
									...
									<tr>
										...
										<td>
											<div class="main__table-text"><a href="<?= base_url('public/admin/')?>#">Matt Jones</a></div>
										</td>
										<td>
									...
									<tr>
										...
										<td>
											<div class="main__table-text"><a href="<?= base_url('public/admin/')?>#">Tess Harper</a></div>
										</td>
										<td>
									...
									<tr>
										...
										<td>
											<div class="main__table-text"><a href="<?= base_url('public/admin/')?>#">Jonathan Banks</a></div>
										</td>
										<td>
				...
				<div class="col-12 col-xl-6">
					<div class="dashbox">
						<div class="dashbox__title">
							...
							<div class="dashbox__wrap">
								<a class="dashbox__refresh" href="<?= base_url('public/admin/')?>#"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M21,11a1,1,0,0,0-1,1,8.05,8.05,0,1,1-2.22-5.5h-2.4a1,1,0,0,0,0,2h4.53a1,1,0,0,0,1-1V3a1,1,0,0,0-2,0V4.77A10,10,0,1,0,22,12,1,1,0,0,0,21,11Z"/></svg></a>
								<a class="dashbox__more" href="<?= base_url('public/admin/')?>reviews.html">View All</a>
							</div>
						</div>
